...
struct _R {
  ...
  struct string {
    ...
    struct infoPlist {
      ...
      /// en translation: MelodyMusic
      ///
      /// Key: CFBundleName
      ///
      /// Locales: en, zh-Hans
      var cfBundleName: RswiftResources.StringResource { .init(key: "CFBundleName", tableName: "InfoPlist", source: source, developmentValue: "MelodyMusic", comment: nil) }
    }
